...
import video1 from "../components/intensive-vid.mp4"
...
export const Overview =()=>{
    return (
        ...
        <Para>
        <p>Indian cooking meets its match! The new IntensiveWash™ Dishwasher has been designed to effectively clean stubborn oil, grease, masala and other food stains. From your finest crockery to everyday utensils, now get every dish sparkling clean and germ-free, easily.</p>
        </Para>
        <Key>
        ...
        <Image>
            ...
            <h2>Triple Rinse</h2>
            <h2>Effectively removes
             grease, oil and masala
               stains.</h2>
            ...
            <h2>Automatically opens the
                door, accelerating drying
                time.</h2>
            ...
            <h2>Hygienic Rinsing</h2>
                            <h2>Eliminates up to 99.9%*
                food bacteria with hot water (70°C)</h2>
            </div>
        </Image>
        <Head>
        <h1>IntensiveWash™ (70°C)* with Triple Rinse</h1>
        <p>Three separate rinse cycles effectively remove every stain from heavily soiled dishes. An extra hot water rinse cycle ensures sparkling, hygienically clean dishes.</p>
        </Head> 
        <div>
        <video autoplay muted loop poster src={video1} width="95%" height="800px" controls="controls">
        ...
        <div>
            ...
            <p>Additional water pressure from three distinct levels of wash arms cleans every corner of every dish perfectly.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/steel-tab-icon.jpg?$ORIGIN_JPG$"/>
            <p>Easily kept hygienically clean, the stainless steel tub withstands high temperatures and prevents build-up of malodours.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/sec4-auto-release-icon.jpg?$ORIGIN_JPG$"/>
            <p>Ensures spotless and faster drying. Door automatically opens 10cm allowing steam to escape.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/sec4-hygine-icon.jpg?$ORIGIN_JPG$"/>
            <p>Extends the final rinse and increases the water temperature to 70˚C for deeper cleaning, killing up to 99.9% * food bacteria**.</p>
        </div>
        </Image1>
        ...
        <div>
            ...
            <p>By moving the upper rack you can create more space in the lower rack to easily fit utensils of all sizes.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/44db-icon.jpg?$ORIGIN_JPG$"/>
            <p>Forget noisy dishwashers! Powered by Insulation technology, it is quieter than even a normal conversation*.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/finger-rasist-icon.jpg?$ORIGIN_JPG$"/>
            <p>Prevents fingerprint marks and smudges, leaving your kitchen looking flawlessly clean and premium.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/wide-display-icon.jpg?$ORIGIN_JPG$"/>
            <p>Monitor the wash performance effortlessly by checking remaining wash time on the display.</p>
        </div>
        </Image2>
        ...
        <div>
            ...
            <p>Got just a few dishes to clean? Press the ‘half load’ button to use
just the lower or upper basket and save energy.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/leakage-sensor-icon.jpg?$ORIGIN_JPG$"/>
            <p>Immediately stops the cycle, drains the water and shows
an error message if any leakage is detected.</p>
        </div>
        <div>
            <img src="https://images.samsung.com/is/image/samsung/assets/in/microsite/dishwashers/high-energy-icon.jpg?$ORIGIN_JPG$"/>
            <p>With a high energy efficiency level, equivalent
to an A+++ rating*, it consumes less energy
without impacting the cleaning performance or functionality.</p>
        </div>
