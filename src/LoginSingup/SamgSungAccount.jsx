...
async function signup() {
    ...
    return(<div>
        ...
        <Div bc={'#171616'} height={'830px'} width={'100%'}>
            ...
            <P color={'white'} cur={'pointer'} fontWeight={'bold'} fontSize={'25px'} padding={'35px 45% 0% 10%'} onClick={()=>{
                navigate('/')
            }}>SAMSUNG Account</P>
            <Div style={{
                    margin: 'auto',
            ...
            <Div width={'100%'} height={'95px'}  style={{
               textAlign:'center',
            }}> <P color={"#0075d4"} fontWeight={''} fontSize={'35px'} >Sign in to your Samsung account</P> </Div>
