        ...
        <SubMain>
            ...
            <Carousel.Item>
                ...
                <Main>
                    ...
                    className="w3-badge w3-blue"
                        ...
                        <br />
                        <br />
                        <p style={{fontSize:"30px",textAlign:'center', fontWeight:'bold'}}>The Freestyle</p>
                        <p style={{fontSize:"14px", textAlign:'center'}}>Just launched.</p>
                        <button id="forhover" style={{marginLeft:"43%"}}>Learn more</button>
                    </div>
                    <div className="box1">
                        <span
                        ...
                        <h5 style={{
                            marginLeft:'10%'
                        }}>The Frame Starting at ₹58990*</h5>
            ...
            <Main>
                ...
                <div className="box1">
                    ...
                    <br />
                    <br />
                    <h5 style={{textAlign:'center'}}>Galaxy Tab A7 Lite Lowest prices ever</h5>
                    <p style={{textAlign:'center'}}>Just launched.</p>
                    <button style={{
                        marginLeft:'33%'
                    }}>Learn more</button>
                ...
                <div className="box1" id="subBox1">
                    ...
                    <h5 style={{
                       textAlign:'center'
                    }}>Galaxy Tab A8 Never before price</h5>
                    <p style={{textAlign:'center'}}>Just launched.</p>
                    <button style={{
                        marginLeft:'33%'
                    }}>Learn more</button>
                ...
                className="w3-badge w3-blue"
                    ...
                    <h5 style={{
                       textAlign:'center'
                    }}>Galaxy Tab S7 FE Starting T 34999*</h5>
                    <p style={{textAlign:'center'}}>Just launched.</p>
                    <button style={{
                        marginLeft:'33%'
                    }}>Learn more</button>
        ...
        <Carousel.Item >
                ...
                <Main>
                    ...
                    <div className="box1">
                        ...
                        <br />
                        <br />
                        <h5 style={{textAlign:'center'}}>Intensive Dishwasher Starting T 35990*</h5>
                        <p style={{textAlign:'center'}}>Just launched.</p>
                        <button style={{
                            marginLeft:'33%'
                        }}>Learn more</button>
                    ...
                    <div className="box1" id="subBox1">
                        ...
                        <h5 style={{
                           textAlign:'center'
                        }}>AI EcOBubble Starting 34390*</h5>
                        <p style={{textAlign:'center'}}>Just launched.</p>
                        <button style={{
                            marginLeft:'33%'
                        }}>Learn more</button>
                    ...
                    className="w3-badge w3-blue"
                        ...
                        <h5 style={{
                            textAlign:'center'
                        }}>Wobble Technology StartingT 20600*</h5>
                        <p style={{textAlign:'center'}}>Just launched.</p>
                        <button style={{
                            marginLeft:'33%'
                        }}>Learn more</button>
            ...
            <Main>
                ...
                className="w3-badge w3-blue"
                    ...
                    <br />
                    <br />
                    <button id="forhover" style={{marginTop:'10%', marginLeft:"43%"}}>Learn more</button>
                </div>
                ...
                <div className="box1" style={{
                    ...
                    <p style={{textAlign:'center',marginTop:'-1%'}}>Just launched.</p>
                    <button style={{
                        marginLeft:'33%',marginTop:'-5%'
                    }}>Learn more</button>
                </div>
                ...
                className="w3-badge w3-blue"
                    ...
                    <h5 style={{
                        textAlign:'center',marginTop:'-50%'  
                    }}>Exclusive corporate<br/> offers</h5>
                    <p style={{textAlign:'center'}}>Just launched.</p>
                    <button style={{
                        marginLeft:'35%'
                    }}>Learn more</button>
