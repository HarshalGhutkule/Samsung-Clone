    ...
    <div>
      ...
      />
          <Main  style={{ margin: "39% 20% 20% 17%"  }}>
            ...
            <p style={{ fontFamily:'sans-serif', lineHeight:"20px",marginLeft:'24%' }} >Designed for you, by you</p>
      ...
      />
          <Main  style={{ margin: "39% 20% 20% 25%"  }}>
            ...
            <p style={{ fontFamily:'sans-serif', lineHeight:"20px",marginLeft:'5%' }} >Makes tasty and hygienic curd</p>
      ...
      />
          <Main  style={{ margin: "39% 20% 20% 18%"  }}>
            ...
            <p style={{ fontFamily:'sans-serif', lineHeight:"20px",marginLeft:'15%' ,color:'white' }} >
