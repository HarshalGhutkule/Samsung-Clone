    ...
    <div>
      ...
      />
          <Main  style={{ margin: "50px -8%" }}>
            ...
            <p style={{ fontFamily:'sans-serif', lineHeight:"20px" }} >Change the way you play <br/> Free carry case worth  ₹5900*</p>
        ...
        <Carousel.Item interval={1500}>
          ...
          <Main style={{ margin: "150px -5%" }}>
            <h1  style={{ fontWeight:'bold' }}>Galaxy Book 2 Series <br/> The New Way To PC</h1>
      ...
      />
          <Main  > 
            <h1  style={{ fontWeight:'bold',color:'white', fontSize:'45px',fontFamily:'samsung700'  }}>
            WindFree
            </h1>
