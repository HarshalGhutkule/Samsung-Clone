...
function a(e){
    ...
    return(<>
        ...
        <P fontSize={'36px'} fontWeight={'Bold'} fontf={'cursive'} cur={'pointer'} tdh={'underline'} height={'198px'} width={'98%'}  textAlign = {'center'} marginBottom={'0px'} paddingBottom={'-10px'}  marginTop={'100px'} >Explore #DoWhatYouCant</P>
        ...
        <P paddingLeft={'20px'}  fontSize={'20px'} fontWeight={'Bold'}  fontf={'cursive'}  >01</P>
        <P paddingLeft={'60px'} fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'} >Use Fitness Trackers to Fuel Your Motivation, Not Your Anxiety</P>
        </Div>
        ...
        <P paddingLeft={'20px'}  fontSize={'20px'} fontWeight={'Bold'}  fontf={'cursive'} >02</P>
        <P paddingLeft={'60px'} fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'} >Everyday sustainability Screens Everywhere, Screens for All </P>
        </Div>
        ...
        <P paddingLeft={'20px'}  fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'}  >03</P>
        <P paddingLeft={'60px'} fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'}  >Keep cool 3 Hosting Tips to Alleviate Holiday Stress</P>
        </Div>
        ...
        <P paddingLeft={'20px'}  fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'}  >04</P>
        <P paddingLeft={'60px'}  fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'} >Samsung CES 2022 Keynote Together for tomorrow at CES 2022 </P>
        </Div>
        ...
        <P paddingLeft={'20px'}  fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'}  >05</P>
        <P paddingLeft={'60px'} fontSize={'20px'} fontWeight={'Bold'} fontf={'cursive'} >India's Festive Season Purchase Latest
        Smartphones</P>
        </Div>
        </Div>
